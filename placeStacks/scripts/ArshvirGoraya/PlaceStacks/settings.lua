...
local settingsDefinitions = {
	...
	settingsTakeStacks = {
		...
		settings = {
			...
			{
				key = Keys.CONSTANT_KEYS.CommonSettings.NotifyCountNotTransferred,
				name = Keys.LOCALIZED_KEYS.Settings.NotifyCountNotTransferred.Take.Name,
				description = Keys.LOCALIZED_KEYS.Settings.NotifyCountNotTransferred.Take.Description,
				default = true,
				renderer = "checkbox",
			},
		},
	...
	settingsPlaceStacks = {
		...
		settings = {
			...
			{
				key = Keys.CONSTANT_KEYS.CommonSettings.NotifyCountNotTransferred,
				name = Keys.LOCALIZED_KEYS.Settings.NotifyCountNotTransferred.Place.Name,
				description = Keys.LOCALIZED_KEYS.Settings.NotifyCountNotTransferred.Place.Description,
				default = true,
				renderer = "checkbox",
			},
			{
				key = Keys.CONSTANT_KEYS.CommonSettings.NotifyTypesNotTransferred,
				name = Keys.LOCALIZED_KEYS.Settings.NotifyTypesNotTransferred.Name,
				description = Keys.LOCALIZED_KEYS.Settings.NotifyTypesNotTransferred.Description,
				default = true,
				renderer = "checkbox",
			},
		},
